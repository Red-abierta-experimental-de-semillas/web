  ...
  <main>
    <section class="landing-hero">
      <div class="raes-shell hero-layout">
        ...
        <figure class="hero-image">
          <img src="@/assets/vegetable-varieties-hero.png" alt="Variedades coloridas de hortalizas y semillas" />
        </figure>
      </div>
    </section>
    ...
    <section class="raes-shell section-links">
      <RouterLink :to="{ name: 'what-is-this' }" class="section-card">
        <img src="@/assets/sfg/sfg-1.svg" alt="" />
      ...
      <a href="#projects" class="section-card">
        <img src="@/assets/sfg/sfg-5.svg" alt="" />
      ...
      <RouterLink :to="{ name: 'get-involved' }" class="section-card">
        <img src="@/assets/sfg/sfg-9.svg" alt="" />
        <h2>Involúcrate</h2>
